...
const defaults: StoredConfig = {
  botConfig: {
    sugoRoomId: '1250911',
    botAccountToken: 'KQPzutiWBR8eekzNJkcz7SmVA26FBORg', // FRESH token from latest Proxyman capture
    sugoUid: '47585713',
